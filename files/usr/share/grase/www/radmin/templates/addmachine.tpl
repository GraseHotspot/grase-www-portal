...
<table>
<tr><td>MAC Address<a class="helpbutton" onclick="ShowContent('helpbox','The MAC address is the network hardware address of the computer. It needs to be of the format XX-XX-XX-XX-XX-XX where XX is a hex number, typed in all capitals');" ><img src="/grase/images/icons/help.png" alt=""/></a></td><td><input type="text" name="mac" value='{$machine.mac}'/></td></tr>
