...
<div>
    ...
    <span class="form_or">OR</span>
    <input type="text" class="default_swap" id="MaxTime" name="MaxTime" value='{$machine.MaxTime}' title="Type your own Time Limit"/>
    <span id='Max_TimeInfo'>Choose a Time Limit OR Type your own value</span>
</div>

        <button type="submit" name="newmachinesubmit" value="Create New Machine Account"><img src="/grase/images/icons/tick.png" alt=""/>Create New Machine Account</button>
