...
$singlenetworkoptions = array(
    'lanipaddress' => array(
        ...
        "description" => T_("The server IP address that is used on the LAN side (Coova-Chilli) of the network. This will be the gateway address for all clients, as well as the DNS server the clients access."),
        "type" => "ip",
        "required" => "true"),
    /*'network' => array(
